...
Esto creara la carpeta "es/" dentro del directorio "sounds/". Para utilizarlos basta con anadir a los ficheros de configuración utilizados ("sip.conf", "iax.conf", "zapata.conf", etc.) la siguiente línea:

language=es

Es necesario anadir un enlace simbólico entre "/var/lib/asterisk/sounds/digits/es" y "/var/lib/asterisk/sounds/es/digits" con el fin de que los sonidos de dígitos se escuchen en castellano correctamente con determinadas aplicaciones.
